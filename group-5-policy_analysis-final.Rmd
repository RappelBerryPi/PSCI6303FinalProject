...
percentage.treatment.changed <- percentage(d[number_of_troll_tweets_reported != 0 & `2024_voting_plan` != general_voting_preference], d[number_of_troll_tweets_reported != 0,])
```
