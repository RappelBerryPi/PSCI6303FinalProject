...
```{r}
glimpse(d)
percentage.control <- percentage(d[number_of_troll_tweets_seen == 0,], d)
percentage.treatment <- percentage(d[number_of_troll_tweets_seen != 0,], d)
percentage.control.changed <- percentage(d[number_of_troll_tweets_seen == 0 & `2024_voting_plan` != general_voting_preference], d[number_of_troll_tweets_seen == 0,])
percentage.treatment.changed <- percentage(d[number_of_troll_tweets_seen != 0 & `2024_voting_plan` != general_voting_preference], d[number_of_troll_tweets_seen != 0,])
```
