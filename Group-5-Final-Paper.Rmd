...
> retweets per tweet.” Looking at Trump’s opponent and similar social media activity, this kind of retweet volume did
> not have an impact on her numbers.
...
>  They discovered evidence that social bots had a disproportionate role in the distribution of low-credibility content. Bots boost such material in the early stages of its distribution, before it becomes viral. They also use replies and mentions to target users with a large number of followers. 
...
+ Although this data was generated with the intent  to show that this experiment would succeed, we believe the
  ...
  conclusion.
+ The main challenge we might face in collecting this data is Twitter support to allow us to run this experiment.
